...
namespace Barcline.Hl7.Cda
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("POCD_MT000040.ServiceEvent", Namespace="urn:hl7-org:v3", IsNullable=true)]
    public partial class POCD_MT000040ServiceEvent : CdaObject, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private POCD_MT000040Performer1Collection performerField;
        ...
        public virtual POCD_MT000040Performer1Collection performer
        {
            get
            {
                if (performerField == null)
                {
                    this.performerField = new POCD_MT000040Performer1Collection();
                }
