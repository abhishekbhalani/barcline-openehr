...
namespace Barcline.Hl7.Cda
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("POCD_MT000040.AssignedCustodian", Namespace="urn:hl7-org:v3", IsNullable=true)]
    public partial class POCD_MT000040AssignedCustodian : CdaObject, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// <remarks/>
        [System.ComponentModel.TypeConverter(typeof(System.ComponentModel.ExpandableObjectConverter))]
        public virtual POCD_MT000040CustodianOrganization representedCustodianOrganization
        {
            get
            {
                return representedCustodianOrganizationField;
            }
            set
            {
