...
namespace Barcline.Hl7.Cda
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("POCD_MT000040.Component1", Namespace="urn:hl7-org:v3", IsNullable=true)]
    public partial class POCD_MT000040Component1 : CdaObject, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// <remarks/>
        [System.ComponentModel.TypeConverter(typeof(System.ComponentModel.ExpandableObjectConverter))]
        public virtual POCD_MT000040EncompassingEncounter encompassingEncounter
        {
            get
            {
                return encompassingEncounterField;
            }
            set
            {
