...
namespace Barcline.Hl7.Cda
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("POCD_MT000040.AuthoringDevice", Namespace="urn:hl7-org:v3", IsNullable=true)]
    public partial class POCD_MT000040AuthoringDevice : CdaObject, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private POCD_MT000040MaintainedEntityCollection asMaintainedEntityField;
        ...
        public virtual POCD_MT000040MaintainedEntityCollection asMaintainedEntity
        {
            get
            {
                if (asMaintainedEntityField == null)
                {
                    this.asMaintainedEntityField = new POCD_MT000040MaintainedEntityCollection();
                }
                return asMaintainedEntityField;
            }
            set
            {
