...
namespace Barcline.OpenEhr.Model
{
    ...
    /// <remarks/>
    /// <summary>
    /// Required properties: meaning, range
    /// </summary>
    ...
    [Table("REFERENCE_RANGE", Schema = "openehr")]
    public partial class REFERENCE_RANGE : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        [Required()]
        [System.ComponentModel.TypeConverter(typeof(System.ComponentModel.ExpandableObjectConverter))]
        public virtual DV_INTERVAL range
        {
            get
            {
                return rangeField;
