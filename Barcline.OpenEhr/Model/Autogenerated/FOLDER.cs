...
namespace Barcline.OpenEhr.Model
{
    ...
    [Table("FOLDER", Schema = "openehr")]
    public partial class FOLDER : VERSIONED
    {
        
        private FOLDERCollection foldersField;
        
        private OBJECT_REFCollection itemsField;
        
        [System.Xml.Serialization.XmlElementAttribute("folders")]
        public virtual FOLDERCollection folders
        {
            get
            {
                if (foldersField == null)
                {
                    this.foldersField = new FOLDERCollection();
                }
                return foldersField;
            }
            set
