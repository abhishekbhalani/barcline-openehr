...
namespace Barcline.OpenEhr.Model
{
    ...
    [Table("TermBindingSet", Schema = "openehr")]
    public partial class TermBindingSet : System.ComponentModel.INotifyPropertyChanged
    {
        
        private TERM_BINDING_ITEMCollection itemsField;
        ...
        public virtual TERM_BINDING_ITEMCollection items
        {
            get
            {
                if (itemsField == null)
                {
                    this.itemsField = new TERM_BINDING_ITEMCollection();
                }
                return itemsField;
            }
            set
