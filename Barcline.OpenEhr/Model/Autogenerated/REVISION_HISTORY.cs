...
namespace Barcline.OpenEhr.Model
{
    ...
    [Table("REVISION_HISTORY", Schema = "openehr")]
    public partial class REVISION_HISTORY : System.ComponentModel.INotifyPropertyChanged
    {
        
        private REVISION_HISTORY_ITEMCollection itemsField;
        
        [System.Xml.Serialization.XmlElementAttribute("items")]
        [Barcline.Core.MinOccurs("0")]
        [Barcline.Core.MaxOccurs("unbounded")]
        public virtual REVISION_HISTORY_ITEMCollection items
        {
            get
            {
                if (itemsField == null)
                {
                    this.itemsField = new REVISION_HISTORY_ITEMCollection();
                }
                return itemsField;
            }
            set
